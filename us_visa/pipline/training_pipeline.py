...
class TrainPipeline:
    ...
    def start_data_validation(self,data_ingestion_artifact:DataIngestionArtifact)->DataValidationArtifact:
        ...
        """
        logging.info('Entered the start_data_validation mothod of TrainPipeline class')
...
#
    ...
    def run_pipeline(self, ) -> None:
        ...
        try:
            ...
            self.model_trainer_artifact = self.start_model_trainer(data_transformation_artifact=self.data_transformation_artifact)
